...
/* token definition */
%token<int_val> Char Int Float Double PR_IF PR_ELSE PR_WHILE PR_FOR PR_CONTINUE PR_BREAK PR_SWITCH PR_RETURN PR_MAIN
%token<int_val> PR_VECTOR op_mas op_por op_div  Inc Dec  op_igual op_mayor op_menor op_mayorigual op_menorigual op_dosigual op_negacion
%token<int_val>  guion llave_a llave_c par_a par_c cor_a cor_c coma punto punto_coma dos_puntos
%token <symtab_item>   id
%token <int_val>       ICONST 
%token <double_val>    numero
%token <char_val>      CCONST
%token <str_val>       STRING  cadena 

/* precedencies and associativities */
%left par_a par_c  cor_c  cor_a
%right op_negacion Inc Dec 
%left op_por op_div
%left op_mas
%left op_igual
%left  coma 
...
program: Int PR_MAIN par_a par_c llave_a lista_declaraciones lista_proposiciones  PR_RETURN numero llave_c ;
